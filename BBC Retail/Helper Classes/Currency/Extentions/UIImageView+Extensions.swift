...
//extension UIImageView {
//    
//    public func setImageForName(string: String, backgroundColor: UIColor? = nil, circular: Bool, textAttributes: [NSAttributedString.KeyNSAttributedString.Key: AnyObject]?, gradient: Bool = false) {
//        
...
//    }
//    
//    public func setImageForName(string: String, gradientColors: GradientColors? = nil, circular: Bool = true, textAttributes: [NSAttributedString.KeyNSAttributedString.Key: AnyObject]? = nil) {
//        
...
//    }
//    
//    public func setImageForName(string: String, backgroundColor: UIColor? = nil, circular: Bool, textAttributes: [NSAttributedString.KeyNSAttributedString.Key: AnyObject]? = nil, gradient: Bool = false, gradientColors: GradientColors? = nil) {
//        
